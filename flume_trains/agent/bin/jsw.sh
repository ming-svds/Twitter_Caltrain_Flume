...
# Application
APP_NAME="flume_trains"
APP_LONG_NAME="flume_trains"
APP_DESCRIPTION="jsw wrapper for trains data collection"

# Wrapper
WRAPPER_CMD="wrapper"
WRAPPER_CONF="$FLUME_TRAINS_HOME/agent/etc/conf/wrapper.conf"
...
PIDDIR="$FLUME_TRAINS_HOME/agent/etc"
